...
<div class="col-md-4">
	...
	<div class="box-header with-border">
		<h3 class="box-title"><i class="fa fa-pie-chart"></i> Vehicle Weekly Profit</h3>
	</div>
	<div class="box-body">
<?php
 if($report)
 {
  foreach($report as $date => $data)
  {
    ...
    $chart_business[] = array('name'=>date("d-m",strtotime($date)),'y'=>$data['customer'] - $data['merchant'] - $data['rent'],'toolval'>'yaya');
  }
 }
		...
		'options' => [	
			...
			'series'=> [
				[
					...
					'data'=>$chart_vehicle,
					'tooltip' => [
   'formatter' => new JsExpression('function(){ return this.series.test; }')
]
				]
			]
		],
...
<!---Business Weekly Profit--->
<div class="col-md-4">
	<div class="box box-info">
	<div class="box-header with-border">
		<h3 class="box-title"><i class="fa fa-pie-chart"></i> Business Weekly Profit</h3>
	</div>
	<div class="box-body">
<?php
	echo Highcharts::widget([
