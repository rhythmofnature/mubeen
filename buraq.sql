...
--
-- Host: localhost
-- Generation Time: Jan 30, 2016 at 04:14 PM
...
CREATE TABLE IF NOT EXISTS `bur_balance_sheet` (
...
CREATE TABLE IF NOT EXISTS `bur_customer_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `bur_customer_details` (`id`, `name`, `place`, `address`, `account_details`, `customer_type`, `phone`, `vehicle`, `earning_percentage`, `status`) VALUES
(3, 'Sahadhevan', 'Kannur', 'Palerimanikyam\r\nKannur', 'HDFC0000001\r\nKoramangala\r\n28079951129', 1, '9164819973', 6, 0.00, '1'),
(4, 'Hairs N.H', 'Kaakanad', 'Haris Nivas\r\nKaakanad\r\nErnakulam', 'INGVY000001\r\nKaakanad\r\n74436875647', 1, '9164819973', 0, 0.00, '1'),
(5, 'Abhishek Nair', 'Karunagappally', 'Madathil veedu\r\nAdinadu South\r\nkarunagappally', 'HDFC000003\r\nKarunagappally\r\n900005436143', 2, '7259960525', 0, 0.00, '1'),
(6, 'Baburaj Thomas', 'Manjeri', 'Vytilla P.O\r\nPin 763439', 'ICICI000076\r\nErnakulam\r\n838728008342', 2, '7259960525', 0, 0.00, '1'),
(7, 'Sreeraj', 'Ernakulam', 'Kaakanad P.O\r\nIrumpanam', 'CANARA0000001\r\n654623383234', 2, '9164819973', 0, 0.00, '1'),
(8, 'Liju Mathew', 'Kayankulam', 'Perampra\r\nKayankulam', 'HDFC000000003\r\n342567686732', 1, '7259960525', 0, 0.00, '1'),
(9, 'Aneesh Madhavan', 'Karunagappally', 'Madhav Nivas\r\nKollam', 'INGVYS00000009\r\n873284293434', 1, '7259960525', 0, 0.00, '1'),
(10, 'Vytilla Paapan', 'Kaakanad', 'Madathil Veedu\r\nAdinadu South', 'HDFC0000098\r\n76536576865', 2, '7259960525', 0, 0.00, '1'),
(11, 'Saju Nair', 'Trivandrum', 'Saju Bhavanam\r\nMutharakunnu P.O', 'HDFC0000008\r\n72348723234', 1, '9164819973', 0, 0.00, '1'),
(12, 'Prayikara Paapan', 'Mutharakunnu P.O', 'Mutharamkunnu P.O\r\nAdinadu North', 'CORP999811\r\n19263511222', 2, '9164819973', 0, 0.00, '1'),
(13, 'Smithesh', 'Ambalapady', 'Ambalakattu House Pallikkara', 'Test account', 3, '46457457457', 7, 10.00, '1');
...
CREATE TABLE IF NOT EXISTS `bur_customer_material_price` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `customer_id` int(11) NOT NULL,
...
INSERT INTO `bur_customer_material_price` (`id`, `customer_id`, `material_id`, `price`, `status`) VALUES
(1, 5, 1, 100.00, '1'),
(2, 4, 3, 33.00, '1'),
(3, 4, 4, 44.00, '1'),
(4, 3, 3, 150.00, '1'),
...
CREATE TABLE IF NOT EXISTS `bur_customer_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(250) NOT NULL,
...
INSERT INTO `bur_customer_type` (`id`, `name`, `description`, `status`) VALUES
(1, 'Buyer', '', '1'),
(2, 'Seller', '', '1');
...
CREATE TABLE IF NOT EXISTS `bur_driver_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(250) NOT NULL,
  `address` text NOT NULL,
...
INSERT INTO `bur_driver_details` (`id`, `name`, `address`, `dob`, `mobile`, `vehicle`, `earning_percentage`, `status`) VALUES
(3, 'Premraj', 'Bangalore 13th main\r\n12th Cross,2nd Stage\r\nKoramangala', '1980-02-03 00:00:00', '7259960525', '6', '5.3', 1),
(4, 'Vasudevan Chettiar', 'Vasudevan nivas\r\nKaakanad', '1981-01-01 00:00:00', '9164819973', '7', '12.7', 1),
(5, 'Test Driver', 'test address', '1986-04-26 00:00:00', '9946291945', '8', '10', 1);
...
CREATE TABLE IF NOT EXISTS `bur_form_input_table` (
...
INSERT INTO `bur_form_input_table` (`field_input_id`, `field_name`, `field_display_name`, `form_id`, `field_type`, `field_refference_table`, `field_condition`, `fields_involved`, `attributes`, `use_table_feature`, `validation`, `record_status`, `sort_order`) VALUES
(14, 'name', 'Vehicle Name', 1, 'text', '', '', '', 'class=''input''', 1, 'required', 1, 1),
(15, 'type', 'Vehicle Type', 1, 'select', 'vehicle_type', 'status=1', 'id,name', '', 1, 'required', 1, 2),
(16, 'vehicle_number', 'Vehicle Registration Number', 1, 'text', '', '', '', 'class=''input''', 1, 'required', 1, 3),
(17, 'size', 'Vehicle Size', 1, 'text', '', '', '', '', 1, 'required', 1, 4),
(22, 'charge_per_km', 'Charge Per Kilometre', 1, 'text', '', '', '', '', 1, 'required', 1, 5),
(23, 'name', 'Material', 2, 'text', '', '', '', '', 0, 'required', 1, 1),
(24, 'description', 'Material Description', 2, 'textarea', '', '', '', '', 1, '', 1, 2),
(25, 'measurement_type', 'Measurement Type', 2, 'select', 'measurement', 'status=1', 'id,name', '', 1, 'required', 1, 3),
(26, 'name', 'Customer Name', 3, 'text', '', '', '', '', 1, 'required', 1, 1),
(27, 'place', 'Place', 3, 'text', '', '', '', '', 1, 'required', 1, 2),
(28, 'address', 'Address', 3, 'textarea', '', '', '', '', 1, 'required', 1, 3),
(29, 'account_details', 'Account Details', 3, 'textarea', '', '', '', '', 1, 'required', 1, 4),
(30, 'customer_type', 'Customer Type', 3, 'select', 'customer_type', 'status=1', 'id,name', '', 1, 'required', 1, 5),
(31, 'phone', 'Customer contact number', 3, 'text', '', '', '', '', 1, 'required|numeric', 1, 6),
(32, 'name', 'Name of the driver', 4, 'text', '', '', '', '', 0, 'required', 1, 1),
(33, 'address', 'Address', 4, 'textarea', '', '', '', '', 1, 'required', 1, 2),
(34, 'dob', 'Date of Birth', 4, 'text', '', '', '', 'class=''datepicker''', 1, '', 1, 3),
(35, 'mobile', 'Mobile number', 4, 'text', '', '', '', '', 1, 'required|numeric', 1, 4),
(36, 'vehicle', 'Vehicle', 4, 'select', 'vehicle_details', 'status=1', 'id,vehicle_number', '', 1, 'required', 1, 5),
(37, 'earning_percentage', 'Earning Percentage', 4, 'text', '', '', '', '', 0, 'required', 1, 6),
(38, 'field_name', 'Field name as per the table', 5, 'text', '', '', '', '', 1, '', 1, 1),
(39, 'field_display_name', 'Display Field Name', 5, 'text', '', '', '', '', 1, '', 1, 2),
(40, 'form_id', 'Form id number', 5, 'text', '', '', '', '', 1, '', 1, 3),
(41, 'field_type', 'Field Type (input,select,checkbox,radio,file,textarea)', 5, 'radio', '', '', 'select|textarea|checkbox|file|radio|text', '', 1, '', 1, 4),
(42, 'field_refference_table', 'Table reference incase of dropdown', 5, 'text', '', '', '', '', 1, '', 1, 5),
(43, 'field_condition', 'Table Condition', 5, 'textarea', '', '', '', '', 1, '', 1, 6),
(44, 'fields_involved', 'Involved Selecting Fields', 5, 'text', '', '', '', '', 0, '', 1, 7),
(45, 'attributes', 'Attributes like class', 5, 'text', '', '', '', '', 1, '', 1, 8),
(46, 'use_table_feature', 'Use Table feature', 5, 'radio', '', '', 'Yes|No', '', 1, '', 1, 9),
(47, 'validation', 'Validation', 5, 'text', '', '', '', '', 1, '', 1, 10),
(48, 'sort_order', 'Sort order', 5, 'text', '', '', '', '', 1, '', 1, 11),
(49, 'date_of_travel', 'Date of Travel', 6, 'text', '', '', '', 'class=''datepicker''', 0, 'required', 1, 1),
(50, 'vehicle_id', 'Vehicle', 6, 'select', 'vehicle_details', 'status=1', 'id,vehicle_number', '', 0, 'required', 1, 2),
(51, 'driver_id', 'Driver', 6, 'select', 'driver_details', 'status=1', 'id,name', '', 0, 'required', 1, 3),
(52, 'material_id', 'Material', 6, 'select', 'material_types', 'status=1', 'id,name', '', 0, 'required', 1, 4),
(53, 'size', 'Size', 6, 'text', '', '', '', '', 0, 'required', 1, 5),
(54, 'measurement_type', 'Measurement', 6, 'select', 'measurement', 'status=1', 'id,name', '', 0, 'required', 1, 6),
(55, 'seller', 'From', 6, 'select', 'cusomer_details', 'customer_type=2 AND status=1', 'id,name', '', 0, 'required', 1, 7),
(56, 'buyer', 'To', 6, 'select', 'cusomer_details', 'customer_type=1 AND status=1', 'id,name', '', 0, 'required', 1, 8),
(57, 'site_name', 'Site name', 6, 'text', '', '', '', '', 0, '', 1, 9),
(58, 'site_place', 'Site Place', 6, 'text', '', '', '', '', 0, '', 1, 10),
(59, 'kilometre', 'Kilometre', 6, 'text', '', '', '', '', 0, 'required', 1, 11),
(60, 'amount', 'Amount', 6, 'text', '', '', '', '', 0, 'required', 1, 12),
(61, 'vehicle_rent', 'Vehicle Rent', 6, 'text', '', '', '', 'id=''vehicle_rent''', 0, 'required', 1, 13),
(62, 'total_amount', 'Total Amount', 6, 'text', '', '', '', '', 0, '', 1, 14),
(63, 'amount_buyer', 'Amount from Buyer', 6, 'text', '', '', '', '', 0, '', 1, 15),
(65, 'status', 'Status', 1, 'select', 'parameter', 'parameter_group=''STATUS'' AND parameter_status=1', 'parameter_val,parameter_name', '', 0, 'required', 1, 6),
(66, 'status', 'Status', 2, 'select', 'parameter', 'parameter_group=''STATUS'' AND parameter_status=1', 'parameter_val,parameter_name', '', 0, 'required', 1, 4),
(67, 'status', 'Status', 3, 'select', 'parameter', 'parameter_group=''STATUS'' AND parameter_status=1', 'parameter_val,parameter_name', 'id=''vehicle_rent''', 0, 'required', 1, 7),
(68, 'status', 'Status', 4, 'select', 'parameter', 'parameter_group=''STATUS'' AND parameter_status=1', 'parameter_val,parameter_name', '', 0, 'required', 1, 7),
(69, 'buyer_trip_sheet_number', 'Buyer trip sheet number', 6, 'text', '', '', '', '', 0, '', 1, 17),
(70, 'seller_trip_sheet_number', 'Seller Trip sheet number', 6, 'text', '', '', '', '', 0, '', 1, 19);
...
CREATE TABLE IF NOT EXISTS `bur_material_types` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(250) NOT NULL,
  `description` text NOT NULL,
...
INSERT INTO `bur_material_types` (`id`, `name`, `description`, `measurement_type`, `status`) VALUES
(3, 'Metal rods', 'Metal rods', 1, '1'),
(4, 'Rock & Steel', 'Rock & Steel', 1, '1'),
(5, 'Bricks', 'Bricks', 2, '1');
...
CREATE TABLE IF NOT EXISTS `bur_measurement` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(250) NOT NULL,
  `description` text NOT NULL,
  `status` varchar(1) NOT NULL,
...
INSERT INTO `bur_measurement` (`id`, `name`, `description`, `status`) VALUES
(1, 'Feet', '', '1'),
(2, 'Numbers', '', '1');
...
CREATE TABLE IF NOT EXISTS `bur_parameter` (
...
INSERT INTO `bur_parameter` (`parameter_id`, `parameter_name`, `parameter_val`, `parameter_desc`, `parameter_group`, `parameter_status`) VALUES
(1, 'Active', '1', '', 'STATUS', 1),
(2, 'In Active', '0', '', 'STATUS', 1);
...
CREATE TABLE IF NOT EXISTS `bur_transactions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `customer_id` int(11) NOT NULL,
  `amount` float NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bur_trips` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `driver_amount` decimal(7,2) NOT NULL,
  `merchant_amount` decimal(7,2) NOT NULL,
  `buyer_amount` decimal(7,2) NOT NULL,
  `buyer_amount_total` decimal(7,2) NOT NULL,
...
INSERT INTO `bur_trips` (`id`, `date_of_travel`, `vehicle_id`, `driver_id`, `material_id`, `size`, `measurement_type`, `merchant`, `buyer`, `site_name`, `site_place`, `kilometre`, `vehicle_rent`, `driver_amount`, `merchant_amount`, `buyer_amount`, `buyer_amount_total`, `buyer_trip_sheet_number`, `seller_trip_sheet_number`) VALUES
(1, '2015-12-28 00:00:00', 7, 4, 3, 'A4 Club class 6', 2, 0, 0, 'Karunagappally North P.O', 'Adinadu Villege', '150', 5000.00, 0.00, 0.00, 0.00, 0.00, 'KP009272', 'SL7732424'),
(2, '2015-12-28 00:00:00', 6, 3, 3, 'A4 Club class 6', 1, 0, 0, 'Karunagappally North P.O', 'Adinadu Villege', '137', 5000.00, 0.00, 0.00, 0.00, 0.00, 'KP009272', 'SL7732424'),
(3, '2015-12-31 00:00:00', 7, 4, 3, 'Omega 3 Plus', 2, 0, 0, 'Manjeri Mukkam', 'Malappuram', '308', 1200.00, 0.00, 0.00, 0.00, 0.00, 'BUY2937', 'SELL9345435'),
(4, '2015-12-31 00:00:00', 7, 4, 3, 'Omega 3 Plus', 2, 0, 0, 'Manjeri Mukkam', 'Malappuram', '308', 1200.00, 0.00, 0.00, 0.00, 0.00, 'BUY2937', 'SELL9345435'),
(5, '2015-12-31 00:00:00', 7, 4, 3, 'Omega 3 Plus', 2, 0, 0, 'Manjeri Mukkam', 'Malappuram', '308', 1200.00, 0.00, 0.00, 0.00, 0.00, 'BUY2937', 'SELL9345435'),
(6, '2015-12-31 00:00:00', 7, 4, 3, 'Omega 3 Plus', 2, 0, 0, 'Manjeri Mukkam', 'Malappuram', '308', 1200.00, 0.00, 0.00, 0.00, 0.00, 'BUY2937', 'SELL9345435'),
(7, '2015-12-31 00:00:00', 7, 4, 3, 'Omega 3 Plus', 2, 0, 0, 'Near Paathus house', 'Malappuram', '308', 1200.00, 0.00, 0.00, 0.00, 0.00, 'BUY2937', 'SELL9345435'),
(8, '2015-12-31 00:00:00', 7, 4, 3, 'Omega 3 Plus', 2, 0, 0, 'Manjeri Mukkam', 'Malappuram', '308', 1200.00, 0.00, 0.00, 0.00, 0.00, 'BUY2937', 'SELL9345435'),
(9, '2015-12-28 00:00:00', 6, 3, 3, 'A4 Club class 6', 1, 0, 0, 'Karunagappally North P.O', 'Adinadu Villege', '137', 5000.00, 0.00, 0.00, 0.00, 0.00, 'KP009272', 'SL7732424'),
(10, '2015-12-27 00:00:00', 6, 3, 3, 'Violin Club class', 2, 0, 0, 'Adinadu North', 'Kaatilkadavu P.O', '100', 1000.00, 0.00, 0.00, 0.00, 0.00, 'BUY0982', 'SELL9812'),
(11, '2015-12-29 00:00:00', 6, 3, 3, '50', 1, 0, 0, 'Asset  home', 'thripuniyhura', '15', 500.00, 0.00, 0.00, 0.00, 0.00, '1111', '2222');
...
CREATE TABLE IF NOT EXISTS `bur_vehicle_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(250) NOT NULL,
  `type` int(11) NOT NULL,
...
INSERT INTO `bur_vehicle_details` (`id`, `name`, `type`, `vehicle_number`, `size`, `charge_per_km`, `status`) VALUES
(6, 'Universal Tripper Services', 1, 'KL02A 5541', 'Large Tipper Lorry Size1', '21.5', '1'),
(7, 'Lorry Service Center', 2, 'KA 25 4898', 'Medium Lorry', '17', '1'),
(8, 'test Name', 1, 'Kl-40 E 7091', '5.2', '1000', '1');
...
CREATE TABLE IF NOT EXISTS `bur_vehicle_sizes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `size` varchar(250) NOT NULL,
...
INSERT INTO `bur_vehicle_sizes` (`id`, `size`, `status`) VALUES
(1, 'Small', 1),
(2, 'Medium', 1);
...
CREATE TABLE IF NOT EXISTS `bur_vehicle_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(250) NOT NULL,
  `status` varchar(1) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `bur_vehicle_type` (`id`, `name`, `status`) VALUES
(1, 'Tipper', '1'),
(2, 'Lorry', '1');
...
(5, 'France', '2015-09-19 14:28:19', 1, '2015-09-19 14:28:27', 1, 2);
...
(23, '', 1, '17-1-1375764288.jpeg', '2015-05-28 14:49:36', 1, 17, 1),
...
(14, 1, 0, '2015-05-28 17:08:13', '2016-01-09 13:11:20', '192.168.1.109'),
(15, 1, 0, '2015-05-28 17:41:47', '2016-01-09 13:11:20', '192.168.1.101'),
(16, 1, 0, '2015-05-28 18:17:21', '2016-01-09 13:11:20', '127.0.0.1'),
(17, 1, 0, '2015-09-05 13:21:39', '2016-01-09 13:11:20', '127.0.0.1'),
(18, 1, 0, '2015-09-05 17:24:48', '2016-01-09 13:11:20', '127.0.0.1'),
(19, 1, 0, '2015-09-12 18:03:24', '2016-01-09 13:11:20', '127.0.0.1'),
(20, 1, 0, '2015-09-19 14:28:03', '2016-01-09 13:11:20', '127.0.0.1'),
(21, 1, 0, '2015-09-19 19:08:01', '2016-01-09 13:11:20', '127.0.0.1'),
(22, 1, 0, '2015-09-27 14:52:16', '2016-01-09 13:11:20', '127.0.0.1'),
(23, 1, 0, '2015-09-27 16:13:36', '2016-01-09 13:11:20', '127.0.0.1'),
(24, 1, 0, '2015-09-27 17:03:02', '2016-01-09 13:11:20', '127.0.0.1'),
(25, 1, 0, '2016-01-09 11:13:03', '2016-01-09 13:11:20', '127.0.0.1'),
(26, 1, 0, '2016-01-09 11:13:08', '2016-01-09 13:11:20', '127.0.0.1'),
(27, 1, 0, '2016-01-09 11:14:50', '2016-01-09 13:11:20', '127.0.0.1'),
(28, 1, 1, '2016-01-09 13:11:27', NULL, '127.0.0.1'),
(29, 1, 1, '2016-01-09 16:31:40', NULL, '127.0.0.1'),
(30, 1, 1, '2016-01-10 09:49:41', NULL, '127.0.0.1'),
(31, 1, 1, '2016-01-10 11:10:41', NULL, '127.0.0.1'),
(32, 1, 1, '2016-01-17 06:53:41', NULL, '127.0.0.1'),
(33, 1, 1, '2016-01-17 07:42:53', NULL, '127.0.0.1'),
(34, 1, 1, '2016-01-17 17:10:18', NULL, '127.0.0.1'),
(35, 1, 1, '2016-01-17 20:16:17', NULL, '127.0.0.1'),
(36, 1, 1, '2016-01-21 11:45:39', NULL, '127.0.0.1'),
(37, 1, 1, '2016-01-21 11:48:47', NULL, '127.0.0.1'),
(38, 1, 1, '2016-01-21 13:45:12', NULL, '127.0.0.1'),
(39, 1, 1, '2016-01-23 10:28:25', NULL, '127.0.0.1'),
(40, 1, 1, '2016-01-23 22:18:22', NULL, '127.0.0.1'),
(41, 1, 1, '2016-01-24 16:58:04', NULL, '127.0.0.1'),
(42, 1, 1, '2016-01-30 15:57:15', NULL, '127.0.0.1');
