...
--
-- Host: localhost
-- Generation Time: Jan 23, 2016 at 10:18 PM
...
(13, 'Smithesh', 'Ambalapady', 'Ambalakattu House Pallikkara', 'Test account', 3, '46457457457', 6, 10.00, '1');
...
CREATE TABLE IF NOT EXISTS `bur_transactions` (
  ...
  `from_or_to` enum('to','from') NOT NULL,
  `created_on` date NOT NULL,
  `updated_on` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
